...
@interface FiatCapitaAccountCell()
...
@implementation FiatCapitaAccountCell

-(void)setUpViews{
    
    self.backgroundColor = white_color;
    
    NSArray * btnTitles = @[kLocalizedString(@"充币"),@"C2C/B2C",kLocalizedString(@"资金划转")];
    ...
    statusLabel.text = kLocalizedString(@"积分充值");
    ...
    [subLeftLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo((MAIN_SCREEN_WIDTH-Adapted(24))/3.0);
    }];
...
-(void)setModel:(FiatCapListModel *)model{
    _model = model;
