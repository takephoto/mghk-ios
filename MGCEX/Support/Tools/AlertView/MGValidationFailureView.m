...
@interface MGValidationFailureView()
@property (nonatomic, strong)UIView *alertView;
@property (nonatomic, strong) UIButton *nextBtn;
@property (nonatomic, strong) UIView * toView;
@end

@implementation MGValidationFailureView
...
-(instancetype)initWithMessage:(NSString *)message sureBtnClick:(sureBlock)sureBlock cancelBtnClick:(cancelBlock)cancelBlock{
    ...
    if (self) {
        ...
        [self.alertView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.mas_equalTo(Adapted(215));
        }];
        ...
        titleLabel.font = H15;
        titleLabel.text = kLocalizedString(@"审核通知");
        ...
        [self.alertView mas_updateConstraints:^(MASConstraintMaker *make) {
            make.height.mas_equalTo(height+Adapted(120));
        }];
