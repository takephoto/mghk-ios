	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:IMAGE(@"PlayButtonOverlayLarge") forState:UIControlStateNormal];
                ...
                [playButton setImage:IMAGE(@"PlayButtonOverlayLargeTap") forState:UIControlStateHighlighted];
