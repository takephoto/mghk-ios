 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor k99999Color

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor UIColorFromRGB(0xcdcdcd)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor kMainColor
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor kMainColor
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor kMainColor
 ...
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState UIColorFromRGB(0xf73535)

/**
 *  绘制解锁界面准备好时，提示文字
 */
#define gestureTextBeforeSet  kLocalizedString(@"绘制手势密码") 

/**
 *  设置时，连线个数少，提示文字
 */
#define gestureTextConnectLess [NSString stringWithFormat:@"%@%d%@",kLocalizedString(@"最少连接"),CircleSetCountLeast,kLocalizedString(@"个点,请重新输入")]

/**
 *  确认图案，提示再次绘制
 */
#define gestureTextDrawAgain kLocalizedString(@"再次绘制手势密码") //@"再次绘制手势密码"

/**
 *  再次绘制不一致，提示文字
 */
#define gestureTextDrawAgainError kLocalizedString(@"与上次绘制不一致,请重新绘制")

/**
 *  设置成功
 */
#define gestureTextSetSuccess kLocalizedString(@"设置成功")

/**
 *  请输入原手势密码
 */
#define gestureTextOldGesture kLocalizedString(@"请输入原手势密码")

/**
 *  密码错误
 */
#define gestureTextGestureVerifyError kLocalizedString(@"密码错误")
